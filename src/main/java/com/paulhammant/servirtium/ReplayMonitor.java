...
public interface ReplayMonitor {
    ...
    void urlNotAsExpected(String url, Replayer.ReplayingInteraction rc, String mdMethod, String mdUrl, String filename);
    ...
    class Default implements ReplayMonitor {
        ...
        public void urlNotAsExpected(String url, Replayer.ReplayingInteraction rc, String mdMethod, String mdUrl, String filename) {
