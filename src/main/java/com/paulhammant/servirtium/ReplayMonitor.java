...
public interface ReplayMonitor extends ServerMonitor {
    ...
    void urlNotAsExpected(String url, InteractionReplayingServirtiumServer.ReplayingContext rc, String mdMethod, String mdUrl, String filename);
    ...
    class Default implements ReplayMonitor {
        ...
        public void urlNotAsExpected(String url, InteractionReplayingServirtiumServer.ReplayingContext rc, String mdMethod, String mdUrl, String filename) {
