...
public interface ReplayMonitor {
    ...
    void urlNotAsExpected(String url, InteractionReplayer.ReplayingContext rc, String mdMethod, String mdUrl, String filename);
    ...
    class Default implements ReplayMonitor {
        ...
        public void urlNotAsExpected(String url, InteractionReplayer.ReplayingContext rc, String mdMethod, String mdUrl, String filename) {
